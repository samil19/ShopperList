...
class DetailDisplayer extends React.Component{
    constructor(props){
        super(props);
        this.state = {};
            ...
            <div className="mt-3 row">
                    ...
                    <div className="row">
                        <div className="d-flex justify-content-end">
                             <button className="btn btn-outline-light me-3" onClick={this.props.cleanActive}>Back</button>
                             <button className="btn btn-outline-light me-3" onClick={this.props.editMode}>Edit</button>
